...
MEDIA_ROOT = '/usr/local/www/deploy/Repository'
...
STATIC_ROOT = '/usr/local/www/deploy/static/'
...
STATICFILES_DIRS = (
    ...
    "/usr/local/www/deploy/forensic/ui",
...
SECRET_KEY = 'fa!eyc98laqvl#h-8lq93d)y@4tpu6+k6@825cuqq=&b5%h7pb'
